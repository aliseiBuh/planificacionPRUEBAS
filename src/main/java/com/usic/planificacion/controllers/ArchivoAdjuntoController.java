...
public class ArchivoAdjuntoController {
    ...
    public ResponseEntity<Resource> verDocumento(@PathVariable("idArchivo") Long id) throws IOException {
        ...
        String ruta = projectPath + "/uploads/" + archivoAdjunto.getRutaArchivo();
        ...
        headers.add(HttpHeaders.CONTENT_DISPOSITION, "inline; filename=" + archivoAdjunto.getNombreArchivo()); // "inline"
                                                                                                      // para
                                                                                                      // visualizar
                                                                                                      // en el
                                                                                                      // navegador
        MediaType mediaType = MediaType.parseMediaType(archivoAdjunto.getTipoArchivo());
